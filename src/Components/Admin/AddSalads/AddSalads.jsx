...
import DeleteSalads from "./DeleteSalads";
                            ...
                            return <> <tr>
                                ...
                                <td>
                                    <button className='btn btn-warning m-2' id="go" data-bs-toggle="modal"
                                            data-bs-target="#edit-modal" onClick={() => {editSalads(item.id)}}>Редактировать
                                    </button>
                                </td>
                                <td>
                                    <DeleteSalads id={item.id} getSalads={getSalads}/>
                                </td>
                            </tr>
                                ...
                                <form action="javascript:void(0)">
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" id="add-btn" data-bs-dismiss="modal"
                                                className="btn btn-primary" onClick={addSalads}>Добавить
                                        </button>
                                    </div>
                                </form>
                            </div>
